This is a simple Monk aura module for the [ShotGlass raid frames](http://wow.curseforge.com/addons/shotglass-raid-frames/). You must have that mod installed and enabled for this to do anything.
